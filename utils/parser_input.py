...
def parse_arguments():
    ...
    parser.add_argument('-day', '--day_report', help='create total report', type=str)
    parser.add_argument('-a', '--aigul', help='0.5 or 1 Aigul', default=0.5, type=int)
    parser.add_argument('-f', '--father', help='15 or 25 Father', default=25, type=int)
